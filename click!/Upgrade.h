...
public:
	...
	void AddUpgradeLevel();
	void SetUpgradeLevel(int);
...
inline void Upgrade::AddUpgradeLevel() { this->upgradeLevel++; }
inline void Upgrade::SetUpgradeLevel(int level) { this->upgradeLevel = level; }
